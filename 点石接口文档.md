...
###3.1 新增广告位：http://localhost:8080/v1/adUnit/addAdUnit
请求参数
```json
{
   "adName": "广告名",
...
###3.2根据resId查询: http://localhost:8080/v1/adUnit/getAllAdUnitByRes
 请求参数
 ```json
 {
    "resId": 1
...
```
###3.3根据adId更新：http://localhost:8080/v1/adUnit/updateAdUnit
 请求参数
 ```json
 {
    "adId": 1,
...
###3.4删除：http://localhost:8080/v1/adUnit/deleteAdUnit
请求实例
```json
{
    "adId": 1
...
###3.5调整顺序：http://localhost:8080/v1/adUnit/updateOrder
...
###3.6点击广告：http://localhost:8080/v1/adUnit/clickAd
